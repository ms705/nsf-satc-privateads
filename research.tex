...
Thus, a mechanism for a privacy-preserving ad ecosystem in which all the participants' incentives prevent them from trying to cheat \todo{write this up}
...
\subsubsection{Research Goal 1: Efficient Composable Secure Blind Signatures}
