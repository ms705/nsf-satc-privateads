...
%
The identity of the publisher is a \emph{hidden} attribute, so that if and when the user sends this token to advertiser, the advertiser doesn't learn who the publisher is.% which is important to uphold the publisher's anonymity in the user's following potential interaction with the advertiser.
%
...
\paragraph{Tracking Clicks and Conversions.}
%
