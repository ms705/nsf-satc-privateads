...
%
Must hold advertisers accountable!
%
Tie to credit card functionality/purchasing APIs in browser?
%

\paragraph{Public Key Infrastructure for Signature Verification.}
%
Browser needs to be able to get the necessary keys to sign/verify blind sigs.
%
